...
require(abs(Hod_xc.GetTwoBody(ch, ch, iax, icc) - 6.0) < 1.0e-12,
        "xc mode omitted X-containing-to-CC coupling")
require(abs(Hod_xc.GetTwoBody(ch, ch, iax, ica)) < 1.0e-12,
        "xc mode included X-containing-to-CA coupling")
...
require(abs(Hod_xa.GetTwoBody(ch, ch, iax, ica) - 5.0) < 1.0e-12,
        "xa mode omitted X-containing-to-CA coupling")
...
require(abs(eta_xc.GetTwoBody(ch, ch, iax, icc)) > 1.0e-12 and
        abs(eta_xc.GetTwoBody(ch, ch, iax, ica)) < 1.0e-12,
...
require(abs(eta_xa.GetTwoBody(ch, ch, iax, icc)) < 1.0e-12 and
        abs(eta_xa.GetTwoBody(ch, ch, iax, ica)) > 1.0e-12,
