...
//               { auto& x=self.GetKetIndex_qq(); std::vector<size_t> v(x.begin(),x.end()); return v; })
      ...
      py::class_<ModelSpace>(m, "ModelSpace")
          ...
          .def("SetIMCCPartition", &ModelSpace::SetIMCCPartition, py::arg("emax_cut"))
...
//          .def("GetMP4_Diagram", &HFMBPT::GetMP4_Diagram, py::arg("id"), py::arg("H") )
      ...
      py::class_<IMSRGSolver>(m, "IMSRGSolver")
          ...
          .def("SetIMCCDecoupling", &IMSRGSolver::SetIMCCDecoupling, py::arg("block"))
      ...
      py::class_<Generator>(m, "Generator")
          ...
          .def("SetIMCCDecoupling", &Generator::SetIMCCDecoupling, py::arg("block"))
          .def("GetIMCCDecoupling", &Generator::GetIMCCDecoupling)
          ...
          .def("GetHod_IMCC", &Generator::GetHod_IMCC, py::arg("H"))
          .def("GetIMCCPBlock", &Generator::GetIMCCPBlock, py::arg("H"))
          .def("GetIMCCOffDiagonalNorms", &Generator::GetIMCCOffDiagonalNorms, py::arg("H"))
