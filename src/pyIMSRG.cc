...
//          .def("Print_CC", &ModelSpace::Print_CC)
      ...
      py::class_<Operator>(m, "Operator")
          ...
          .def("SetReducedFlag", [](Operator &self, bool value)
              { self.is_reduced = value; }, py::arg("value"))
...
//           )
      ...
      m.def(
          "TwoBodyChargeOperator",
          &imsrg_util::chiral_charge::TwoBodyChargeOperator,
          py::arg("modelspace"), py::arg("momentum_transfer_mev"),
          py::arg("ge_isoscalar"), py::arg("parameters"));
      m.def(
          "TwoBodyChargeOperatorMPI",
          &imsrg_util::chiral_charge::TwoBodyChargeOperatorMPI,
          py::arg("modelspace"), py::arg("momentum_transfer_mev"),
          py::arg("ge_isoscalar"), py::arg("parameters"));
      m.def("TwoBodyChargeMPIAvailable",
            &imsrg_util::chiral_charge::TwoBodyChargeMPIAvailable);
      m.def("TwoBodyChargeMPIInitialize",
            &imsrg_util::chiral_charge::TwoBodyChargeMPIInitialize);
      m.def("TwoBodyChargeMPIFinalize",
            &imsrg_util::chiral_charge::TwoBodyChargeMPIFinalize);
      m.def("TwoBodyChargeMPIRank",
            &imsrg_util::chiral_charge::TwoBodyChargeMPIRank);
      m.def("TwoBodyChargeMPISize",
            &imsrg_util::chiral_charge::TwoBodyChargeMPISize);
      m.def("TwoBodyChargeMPIBarrier",
            &imsrg_util::chiral_charge::TwoBodyChargeMPIBarrier);
      m.def("TwoBodyChargeMPIAllTrue",
            &imsrg_util::chiral_charge::TwoBodyChargeMPIAllTrue,
            py::arg("local_value"));
